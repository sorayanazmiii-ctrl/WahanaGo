...
$query = "
  ...
  WHERE rt.id_pengguna = $id_pengguna 
    AND rt.status_pembayaran = 'Belum Bayar'
...
<head>
  <meta charset="UTF-8">
  <title>Tiket Saya - WahanaGo</title>
...
<div class="container my-5">
  <h2 class="text-center text-primary fw-bold mb-4">🎟️ Tiket Saya (Aktif)</h2>
  <div class="row g-4">
    <?php if ($result->num_rows > 0): ?>
      ...
      <?php endwhile; ?>
    <?php else: ?>
      <p class="text-center text-muted">Tidak ada tiket aktif.</p>
    <?php endif; ?>
  </div>
</div>
  ...
  printWindow.document.write(`
    <html>
      <head>
        ...
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
        <style>body{padding:20px; font-family:sans-serif;} .card{max-width:500px; margin:auto;}</style>
      </head>
      <body>
        ${ticket.querySelector(".print-area").outerHTML}
      </body>
    </html>
  `);
